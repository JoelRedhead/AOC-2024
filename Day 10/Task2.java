...
public class Task2 {
    ...
    public int dfs(List<String> map, int i, int j, String current) {
        ...
        if (i + 1 < map.size()) {
            if (map.get(i + 1).charAt(j) - current.charAt(current.length() - 1) == 1) {
                count += dfs(map, i + 1, j, current + map.get(i + 1).charAt(j));
            }
        }
        if (i - 1 >= 0) {
            if (map.get(i - 1).charAt(j) - current.charAt(current.length() - 1) == 1) {
        ...
        if (j + 1 < map.get(0).length()) {
            if (map.get(i).charAt(j + 1) - current.charAt(current.length() - 1) == 1) {
                count += dfs(map, i, j + 1, current + map.get(i).charAt(j + 1));
            }
        }
        if (j - 1 >= 0) {
            if (map.get(i).charAt(j - 1) - current.charAt(current.length() - 1) == 1) {
